...
namespace Geo.Itineraries.Web.Common.Helpers
{
    ...
    public static class VenueHelper
    {
        ...
        static VenueHelper()
        {
            ...
            venues.Add("SAMBÍÓIN,_AKUREYRI", new VenueModel { VenueId = 2, VenueName = "Sambíó Akureyri", Latitude = 65.708324, Longitude = -17.517449, Location = "Akureyri" });
            venues.Add("SAMBÍÓIN,AKUREYRI", new VenueModel { VenueId = 2, VenueName = "Sambíó Akureyri", Latitude = 65.708324, Longitude = -17.517449, Location = "Akureyri" });
            venues.Add("SAMBÍÓIN,SELFOSSI", new VenueModel { VenueId = 2, VenueName = "Sambíó Akureyri", Latitude = 63.93615, Longitude = -21.008226, Location = "Akureyri" });
            venues.Add("SAMBÍÓIN,_SELFOSSI", new VenueModel { VenueId = 2, VenueName = "Sambíó Akureyri", Latitude = 63.93615, Longitude = -21.008226, Location = "Akureyri" });
            ...
            venues.Add("KRINGLUBÍÓ", new VenueModel { VenueId = 2, VenueName = "Sambíó Kringlan", Latitude = 64.108031, Longitude = -21.844792, Location = "Reykjavík" });
            ...
            venues.Add("ÁLFABAKKI", new VenueModel { VenueId = 2, VenueName = "Sambíó Álfabakka", Latitude = 64.100997, Longitude = -21.883164, Location = "Reykjavík" });
            ...
            venues.Add("SAMBÍÓIN,_KEFLAVÍK", new VenueModel { VenueName = "Sambíó Keflavík", Latitude = 64.089551, Longitude = -21.938453, Location = "Keflavík" });
            venues.Add("SAMBÍÓ_KEFLAVÍK", new VenueModel { VenueName = "Sambíó Keflavík", Latitude = 64.089551, Longitude = -21.938453, Location = "Keflavík" });
